...
void remmina_pref_on_dialog_destroy(GtkWidget *widget, gpointer user_data)
{
	...
	remmina_pref.allow_check_update = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(remmina_pref_dialog->checkbutton_allow_check_update));
...
static void remmina_pref_dialog_init(void)
{
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(remmina_pref_dialog->checkbutton_allow_check_update), remmina_pref.allow_check_update);
...
GtkDialog* remmina_pref_dialog_new(gint default_tab, GtkWindow *parent)
{
	...
	remmina_pref_dialog->checkbutton_allow_check_update = GTK_CHECK_BUTTON(GET_OBJECT("checkbutton_allow_check_update"));
