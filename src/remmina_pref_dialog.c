...
void remmina_pref_on_dialog_destroy(GtkWidget *widget, gpointer user_data)
{
	...
	remmina_pref.fullscreen_on_all = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(remmina_pref_dialog->checkbutton_appearance_fullscreen_on_all));
...
static void remmina_pref_dialog_init(void)
{
	...
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(remmina_pref_dialog->checkbutton_appearance_fullscreen_on_all), remmina_pref.fullscreen_on_all);
...
GtkDialog* remmina_pref_dialog_new(gint default_tab, GtkWindow *parent)
{
	...
	remmina_pref_dialog->checkbutton_appearance_fullscreen_on_all = GTK_CHECK_BUTTON(GET_OBJECT("checkbutton_appearance_fullscreen_on_all"));
